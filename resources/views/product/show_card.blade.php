    ...
    <header class="header_section">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav">
                   ...
                   <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                       <a class="nav-link" href="{{ route('show.card') }}">Card</a>
                    </li>
                    <li class="nav-item">
     ...
     <div class="py-5 col-lg-12">
                ...
                <tbody>
                  ...
                  $totalprice=0;
                   ...
                   <tr>
                    ...
                    <td>{{ $card->quantity}}</td>
                    <td>{{ $card->price}}</td>
                    <td><img src="/product/{{ $card->image }}" alt="" width="100" height="100"></td>
        ...
        <div class="m-auto text-center">
            ...
            <a href="{{ route('order.show') }}" class="btn btn-danger">Cash On Delivery</a>  <a href="{{ route('striple',$totalprice) }}" class="btn btn-danger">Pay Using Card</a>
        </div>
     </div>
               ...
               <div class="col-md-4">
                   <div class="full">
                      <div class="logo_footer">
                        <a href="#"><img width="210" src="{{ asset('frontend/images/logo.png')}}" alt="#ii" /></a>
                      </div>
